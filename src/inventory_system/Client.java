...
public class Client extends JFrame implements DBInfo, ActionListener, Serializable {
    ...
    protected void createAndShowGUI() {
        ...
        menu = new JMenu("Menu");
        insertButton = new JButton("Add New", new ImageIcon("src/images/insert.png"));
        updateButton = new JButton("Update", new ImageIcon("src/images/update.png"));
        deleteButton = new JButton("Delete", new ImageIcon("src/images/delete.png"));
        selectFirstButton = new JButton(new ImageIcon("src/images/first.png"));
        selectLastButton = new JButton(new ImageIcon("src/images/last.png"));
        selectNextButton = new JButton(new ImageIcon("src/images/next.png"));
        selectPreviousButton = new JButton(new ImageIcon("src/images/previous.png"));
        downloadItem = new JMenuItem("Download", new ImageIcon("src/images/download.png"));
        uploadItem = new JMenuItem("Upload", new ImageIcon("src/images/upload.png"));
        refreshItem = new JMenuItem("Refresh", new ImageIcon("src/images/refresh-data.png"));
        exitItem = new JMenuItem("Exit", new ImageIcon("src/images/exit.png"));
        exitButton = new JButton("Exit", new ImageIcon("src/images/exit.png"));
    ...
    private boolean checkInputs() {
        if(nameField.getText().isEmpty() || priceField.getText().isEmpty() || quantityFiled.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this,
                    "Product information are not updated because one or more fields are empty", "Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        else {
            try {
                if(Integer.parseInt(quantityFiled.getText())<0){
                    throw new NumberFormatException();
                }
                if(Float.parseFloat(priceField.getText()) < 0.01){
                    throw new NumberFormatException();
                } else return true;
            }
